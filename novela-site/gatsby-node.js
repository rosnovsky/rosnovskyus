...
//     // Load templates
//     // const indexTemplate = path.resolve(`./src/components/Layout/`)
//     // const tagsTemplate = path.resolve(`./src/components/tag.js`)
//     // const authorTemplate = path.resolve(`./src/components/author.js`)
//     // const pageTemplate = path.resolve(`./src/components/page.js`)
//     const postTemplate = path.resolve(`./src/templates/articles.template.tsx`)
...
// const query = require('./src/gatsby/data/data.query');
// const normalize = require('./src/gatsby/data/data.normalize');
...
//    * ...
//    */
//   console.debug('Creating', 'articles page');
